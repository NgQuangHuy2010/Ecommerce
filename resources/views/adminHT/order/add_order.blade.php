...
<div class="content-body">
    ...
    <div class="form-group">
        ...
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="idcat[]" value="{{$item->id}}" id="product{{$item->id}}">
                                                    ...
                                                    <div class="form-group">
                                                     <h5>   <label class="text-label">Mô tả</label></h5>
                                                        <div class="input-group">
                                                            <input  class="form-control" id="inputGroupPrepend2" aria-describedby="inputGroupPrepend2" value="{{old('desc')}}" name="desc">
...
<!--                                               
                                    ...
                                    <div class="text-left mt-4 mb-5">
                                        ...
                                        <a class="btn btn-dark btn-sl-sm" href="{{route('ht.order')}}" ><span class="mr-2"><i

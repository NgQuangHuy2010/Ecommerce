                ...
                <div class="row">
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('ht.banner_add')}}" method="post" enctype="multipart/form-data" id="step-form-horizontal" class="step-form-horizontal">
                                @csrf    
                                     ...
                                     <div class="compose-content">
                                            ...
                                            <div  class="d-flex flex-column align-items-center justify-content-center">
                                                <div class="fallback w-100">
                                                    <input type="file" onchange="onUpload(this)" class="dropify" name="image_first" accept="image/*">
                                        ...
                                        <div class="compose-content">
                                            ...
                                            <div  class="d-flex flex-column align-items-center justify-content-center">
                                                <div class="fallback w-100">
                                                    <input type="file" onchange="onUpload(this)" class="dropify" name="image_second" accept="image/*">
                                        ...
                                        <div class="compose-content">
                                            ...
                                            <div  class="d-flex flex-column align-items-center justify-content-center">
                                                <div class="fallback w-100">
                                                    <input type="file" onchange="onUpload(this)" class="dropify" name="image_third" accept="image/*">

...
<div class="container-fluid pt-5">
    ...
    @foreach($loadproduct as $product)
        @if(isset($product->images) && !is_null($product->images))
            @foreach(array_slice($product->images, 2, 4) as $image)
                <img src="{{ asset('public/file/img/img_product/' . $image) }}" alt="Product Image">
            @endforeach
        @endif
    @endforeach
</div> -->
...
<div class="container-xxl py-5 destination">
    <div class="container">
        ...
        <div class="d-flex flex-md-row flex-column justify-content-between align-items-center pb-5">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h1 class="mb-5">Popular Destination</h1>
            </div>
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <button class="btn btn-primary btn-lg btn-block px-5">Đặt Ngay</button>
                <h3 class="text-danger pt-4">10.590.000 vnđ<span class="fs-5">/khách</span></h3>
            </div>
        </div>
        
        <div class="row g-3">
            <!-- Cột 1 - Hiển thị hình ảnh đầu tiên -->
            <div class="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                <a class="position-relative d-block overflow-hidden" href="">
                    @foreach($loadproduct as $product)
                        @if(isset($product->images) && count($product->images) > 0)
                            <img class="img-fluid" src="{{ asset('public/file/img/img_product/' . $product->images[0]) }}" alt="Product Image">
                        @endif
                    @endforeach
                </a>
            </div>
            
            <!-- Cột 2 - Hiển thị hình ảnh thứ 2 -->
            <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.3s">
                <a class="position-relative d-block overflow-hidden" href="">
                    @foreach($loadproduct as $product)
                        @if(isset($product->images) && count($product->images) > 1)
                            <img class="img-fluid" src="{{ asset('public/file/img/img_product/' . $product->images[1]) }}" alt="Product Image">
                        @endif
                    @endforeach
                </a>
            </div>
            
            <!-- Cột 3 - Hiển thị hình ảnh thứ 3 -->
            <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                <a class="position-relative d-block overflow-hidden" href="">
                    @foreach($loadproduct as $product)
                        @if(isset($product->images) && count($product->images) > 2)
                            <img class="img-fluid" src="{{ asset('public/file/img/img_product/' . $product->images[2]) }}" alt="Product Image">
                        @endif
                    @endforeach
                </a>
            </div>
            
            <!-- Cột 4 - Hiển thị hình ảnh thứ 4 -->
            <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.7s">
                <a class="position-relative d-block overflow-hidden" href="">
                    @foreach($loadproduct as $product)
                        @if(isset($product->images) && count($product->images) > 3)
                            <img class="img-fluid" src="{{ asset('public/file/img/img_product/' . $product->images[3]) }}" alt="Product Image">
                        @endif
                    @endforeach
                </a>
            </div>
